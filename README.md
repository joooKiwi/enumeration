...
|-------------------------------------------------------------------------|----------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 3.6.3                                                                   | August 15th, 2024    | [collection](https://github.com/joooKiwi/collection) (~~1.9.2~~ → 1.9.3)                                                                                                                                                                                                                                                                                                                                                                                          |
| 3.6.2                                                                   | July 23rd, 2024      | [collection](https://github.com/joooKiwi/collection) (~~1.9.1~~ → 1.9.2)                                                                                                                                                                                                                                                                                                                                                                                          |
| 3.6.1                                                                   | July 21st, 2024      | [collection](https://github.com/joooKiwi/collection) (~~1.9.0~~ → 1.9.1)                                                                                                                                                                                                                                                                                                                                                                                          |
| 3.6.0                                                                   | July 21st, 2024      | [collection](https://github.com/joooKiwi/collection) (~~1.8.0~~ → [1.9.0](https://github.com/joooKiwi/collection/releases/tag/v1.9.0-js))                                                                                                                                                                                                                                                                                                                         |
| 3.5.0                                                                   | March 31st, 2024     | Addition of [type](https://github.com/joooKiwi/type) to the dependency,<br/>Update to the documentation across the project,<br/>Addition of some future plan                                                                                                                                                                                                                                                                                                      |
| 3.4.0                                                                   | February 19th, 2024  | Formatting across the whole project,<br/>[collection](https://github.com/joooKiwi/collection) (~~1.6.1~~ → [1.7.0](https://github.com/joooKiwi/collection/releases/tag/v1.7.0-js))                                                                                                                                                                                                                                                                                |
...
| [2.4.0](https://github.com/joooKiwi/enumeration/releases/tag/v2.4.0-js) | July 3rd, 2023       | The dependency of `collection` is now a standalone package                                                                                                                                                                                                                                                                                                                                                                                                        |
| [2.3.0](https://github.com/joooKiwi/enumeration/releases/tag/v2.3.0-js) | June 18th, 2023      | New and renaming of some methods in `collection` (see [the release note](https://github.com/joooKiwi/enumeration/releases/tag/v2.3.0-js))                                                                                                                                                                                                                                                                                                                         |
...
| [2.2.0](https://github.com/joooKiwi/enumeration/releases/tag/v2.2.0-js) | June 12th, 2023      | New `join`, `toWeakSet`, `reverse` & `hasNull` in `collection`                                                                                                                                                                                                                                                                                                                                                                                                    |
