...
|----------------------------------------------------------------------------|----------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 3.3.1                                                                      | December 23rd, 2023  | Update from 1.6.0 to 1.6.1 on the [joookiwi/collection](https://github.com/joooKiwi/collection) dependency                                                                                                                                                                                                                                                                                                                                                        |
| 3.3.0                                                                      | December 4th, 2023   | Update from 1.5.0 to [1.6.0](https://github.com/joooKiwi/collection/releases/tag/v1.6.0-js) on the [joookiwi/collection](https://github.com/joooKiwi/collection) dependency                                                                                                                                                                                                                                                                                       |
| 3.2.0                                                                      | September 28th, 2023 | Update from 1.4.0 to [1.5.0](https://github.com/joooKiwi/collection/releases/tag/v1.5.0-js) on the [joookiwi/collection](https://github.com/joooKiwi/collection) dependency,<br/>Change of the exception hierarchy to be only toward the Javascript instead of Java-like                                                                                                                                                                                          |
...
| 2.6.0                                                                      | July 23rd, 2023      | Update from 1.0.4 to [1.1.0](https://github.com/joooKiwi/collection/releases/tag/v1.1.0-js) on the [joookiwi/collection](https://github.com/joooKiwi/collection) dependency                                                                                                                                                                                                                                                                                       |
