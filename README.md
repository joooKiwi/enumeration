...
|----------------------------------------------------------------------------|---------------------|--------------------------------------------------------------------------------------------------------------------------------------------------|
| 2.4.2                                                                      | July 4th, 2023      | The file [EnumHelper](https://github.com/joooKiwi/enumeration/blob/main/javascript/src/EnumHelper.ts) was exported as a type instead of directly |
