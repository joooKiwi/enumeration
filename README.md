...
|----------------------------------------------------------------------------|----------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 3.6.1                                                                      | July 21st, 2024      | [collection](https://github.com/joooKiwi/collection) (~~1.9.0~~ → [1.9.1](https://github.com/joooKiwi/collection/releases/tag/v1.9.0-js))                                                                                                                                                                                                                                                                                                                         |
...
| [2.3.0](https://github.com/joooKiwi/enumeration/releases/tag/v1.3.7)       | June 18th, 2023      | New and renaming of some methods in `collection` (see [the release note](https://github.com/joooKiwi/enumeration/releases/tag/v1.3.7))                                                                                                                                                                                                                                                                                                                            |
...
| [2.2.0](https://github.com/joooKiwi/enumeration/releases/tag/v1.3.3)       | June 12th, 2023      | New `join`, `toWeakSet`, `reverse` & `hasNull` in `collection`                                                                                                                                                                                                                                                                                                                                                                                                    |
