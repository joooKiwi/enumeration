...
export interface CompanionEnumWithGrandParentDeclaration<ENUMERABLE extends EnumerableWithNullableGrandParent<number, string, PARENT_ENUMERABLE, GRAND_PARENT_ENUMERABLE>,
    ...
    PARENT_ENUMERABLE extends EnumerableWithNullableParent<number, string, GRAND_PARENT_ENUMERABLE>,
