...
export class CompanionEnumWithGreatGrandParent<const out ENUM extends EnumerableWithNullableGreatGrandParent<PARENT_ENUM, GRAND_PARENT_ENUM, GREAT_GRAND_PARENT_ENUM>,
    ...
    public override set defaultValue(value: Nullable<| PossibleStringOrNumeric | ENUM | PARENT_ENUM | GRAND_PARENT_ENUM | GREAT_GRAND_PARENT_ENUM>) {
    ...
    public override setDefaultValue(value: Nullable<| PossibleStringOrNumeric | ENUM | PARENT_ENUM | GRAND_PARENT_ENUM | GREAT_GRAND_PARENT_ENUM>,): this
    public override setDefaultValue(value: Nullable<| PossibleStringOrNumeric | ENUM | PARENT_ENUM | GRAND_PARENT_ENUM | GREAT_GRAND_PARENT_ENUM>): this {
    ...
    public override getValue(value: Nullable<| PossibleStringOrNumeric | ENUM | PARENT_ENUM | GRAND_PARENT_ENUM | GREAT_GRAND_PARENT_ENUM>,): ENUM {
    ...
    public override getName(value: Nullable<| PossibleStringOrNumeric | ENUM | PARENT_ENUM | GRAND_PARENT_ENUM | GREAT_GRAND_PARENT_ENUM>,): NameOf<ENUM> {
    ...
    public override getOrdinal(value: Nullable<| PossibleStringOrNumeric | ENUM | PARENT_ENUM | GRAND_PARENT_ENUM | GREAT_GRAND_PARENT_ENUM>,): OrdinalOf<ENUM> {
