...
export class CompanionEnumWithGreatGrandParent<ENUMERABLE extends EnumerableWithNullableGreatGrandParent<number, string, PARENT_ENUMERABLE, GRAND_PARENT_ENUMERABLE, GREAT_GRAND_PARENT_ENUMERABLE>,
