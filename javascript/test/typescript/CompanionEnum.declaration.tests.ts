...
const companionEnum = EnumDeclarationTestInstance.CompanionEnum.get
...
// @ts-expect-error
companionEnum.getValue(EnumWithParentDeclarationTestInstance.A,)
// @ts-expect-error
companionEnum.getValue(EnumWithParentDeclarationTestInstance['0'],)
// @ts-expect-error
...
// @ts-expect-error
companionEnum.getName(EnumWithParentDeclarationTestInstance.A,)
// @ts-expect-error
companionEnum.getName(EnumWithParentDeclarationTestInstance['0'],)
// @ts-expect-error
...
// @ts-expect-error
companionEnum.getOrdinal(EnumWithParentDeclarationTestInstance.A,)
// @ts-expect-error
companionEnum.getOrdinal(EnumWithParentDeclarationTestInstance['0'],)
// @ts-expect-error
